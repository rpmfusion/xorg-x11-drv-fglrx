...
Source0:         https://a248.e.akamai.net/f/674/9206/0/www2.ati.com/drivers/linux/ati-driver-installer-8-9-x86.x86_64.run
...
%changelog
* Sun Oct 05 2008 Thorsten Leemhuis <fedora [AT] leemhuis [DOT] info - 8.532-3.8.09
- rebuild for rpm fusion

* Wed Oct 1 2008 Stewart Adam <s.adam at diffingo.com> - 8.532-2.8.09
...
* Sat Feb 16 2008 Stewart Adam <s.adam AT diffingo DOT com> - 8.455.2-1.8.02
- Update to 8.02
...
* Sun Dec 23 2007 Stewart Adam <s.adam AT diffingo DOT com> - 8.443.1-2.7.12
- Don't provide libGL.so.1
- libs-32bit requires /usr/lib/libGL.so.1.2
